...
VERY IMPORTANT is also to remember that the following flags must be set to true in the main macro file for this to work!
...
Typically, all this should be included in the gate macro:
